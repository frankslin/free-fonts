...
Chunked woff2 webfonts for Plangothic / 遍黑體, generated from Fitzgerald-Porthmouth-Koenigsegg/Plangothic_Project release V2.9.5795.

```html
<link rel="stylesheet" href="./plangothic.css">
```

```css
body {
  font-family: 'Plangothic', sans-serif;
}
```
