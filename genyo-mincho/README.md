# GenYo Serif / 源樣明體 Webfonts

Chunked woff2 webfonts for `GenYo Serif / 源樣明體` TC, generated from ButTaiwan/genyo-font v2.100.

```html
<link rel="stylesheet" href="./genyo-mincho.css">
```
...
- 線上樣張 / Live specimen: <https://free-fonts.digitalhumanities.dev/specimen?font=genyo>
